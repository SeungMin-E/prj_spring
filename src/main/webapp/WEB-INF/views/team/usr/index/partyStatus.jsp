		            ...
		            <div id="entry" class="popup_dim">
		              <div class="entry_wrap">
		                  ...
		                  <div class="entry_contentswrap">
		                      ...
		                      <div class="entry_contents_subtitle">올바른 형식이 아닙니다. 다시 입력해주세요.</div>
		                  </div>
		            ...
		            <div class="chat">
		              ...
		              <div class="login">
		                ...
		                <div class="profile">
		                  ...
		                  <div class="als-container" id="lista1">
		                    <span class="als-prev"><img src="img/profile/left_arrow.png" alt="prev" title="previous" width="100%" /></span>
		                    <div class="als-viewport">
		                      <div class="als-wrapper"></div>
		                    </div>
		                    <span class="als-next"><img src="img/profile/right_arrow.png" alt="next" title="next" width="100%" /></span>
		                  </div>
		                </div>
		                <div class="name">
		                ...
		                <div class="help_contents">
		                  <ul class="help_title_wrap">
		                    ...
		                    <ol class="help_subtitle_wrap">
		                      <li>전송하실 메시지를 입력하고 <span class="btn_send">전송</span>을 클릭하세요.</li>
		                    </ol>
		                  </ul>
		                  <ul class="help_title_wrap">
		                    ...
		                    <ol class="help_subtitle_wrap">
		                      <li>
		                        채팅 입력창 하단의 <span class="help_point"><i class="fas fa-laugh"></i></span> 을 클릭하시면 나타나는 목록에서 원하시는 이모지 또는
		                        이모티콘을 선택하세요.
		                      </li>
		                    </ol>
		                  </ul>
		                  <ul class="help_title_wrap">
		                    ...
		                    <ol class="help_subtitle_wrap">
		                      ...
		                      <li>
		                        귓속말 보내기 : 팝업창에서 <span class="help_point"><i class="fa-regular fa-paper-plane"></i>귓속말 보내기</span> 하단의 입력창에 보내실
		                        메시지를 입력하고 <span>보내기</span>버튼을 클릭하세요.
		                      </li>
		                      <li>
		                        1:1 채팅하기 : 팝업창에서 <span class="help_point"><i class="fa-solid fa-comment"></i>1:1 채팅하기</span>를 클릭하시면 새로운 채팅창이
		                        나타납니다.
		                      </li>
		                      <li>
		                        신고하기 : 팝업창에서 <span class="help_point"><i class="fas fa-not-equal"></i> 신고하기</span>을 클릭하세요.
		                      </li>
		                    </ol>
		                  </ul>
		                  <ul class="help_title_wrap">
		                    ...
		                    <ol class="help_subtitle_wrap">
		                      ...
		                      <li>
		                        대화상대 목록에서 비밀 채팅할 사용자를 선택하고 '<span class="help_point"
		                          ><i class="fas fa-comments" aria-hidden="true"></i> 선택한 멤버들과 비밀 채팅'</span
		                        >을 클릭하세요.
		                      </li>
		                    </ol>
		                  </ul>
		                  <ul class="help_title_wrap">
		                    ...
		                    <ol class="help_subtitle_wrap">
		                      <li>
		                        <span class="invitebtn"><i class="fa-solid fa-user-plus"></i>초대하기</span> 을 누르세요
		                      </li>
		                      <li>나타난 팝업창에서 전송 URL을 복사하거나 초대할 상대방의 이메일 주소를 입력한 후 URL을 전송하세요.</li>
		                    </ol>
		                  </ul>
		                  <ul class="help_title_wrap">
		              ...
		              <div class="downprogress_dim">
		                ...
		                <div class="downprogress_wrap">
		                  ...
		                  <button class="close_ico"><i class="fa-solid fa-xmark"></i></button>
		                  <div class="downprogress_content_wrap">
		                    <div class="downprogress_subtitle">선택한 파일을 저장하는 중입니다.</div>
		                    <div class="down_contents_count">
		                      <span class="current_contents">1</span><span class="contents_mid">/</span><span class="general_contents">1</span>
		                    </div>
		                    <progress value="10" min="0" max="100" class="downprogress_bar"></progress>
		                    <div class="contents_volume_wrap"><span class="current_volume">1MB</span>/<span class="general_volume">2MB</span></div>
		                  </div>
		                ...
		                <div class="gather-file-subwrap">
		                  ...
		                  <div class="file-content-wrap image-wrap">
		                    <ul class="file-preview-list">
		                      <li class="file-preview-image">
		                        <img src="https://s.pstatic.net/static/www/mobile/edit/20220415/cropImg_728x360_91930385614927605.jpeg" />
		                      </li>
		                      <li class="file-preview-image">
		                        <img src="https://s.pstatic.net/static/www/mobile/edit/20220415/cropImg_728x360_91930385614927605.jpeg" />
		                      </li>
		                    ...
		                    <ul class="file-selet-count-wrap">
		                      <li class="file-selet-count">
		                        <i class="fa-solid fa-circle-xmark"></i>
		                        <span class="select-count">0</span><span>개 선택</span>
		                      </li>
		                      <li class="file-down-btn"><i class="fa-solid fa-download"></i></li>
		                    </ul>
		                  </div>
		                    ...
		                    <ul class="file-preview-list">
		                      <li class="file-preview-file">
		                        <div class="gather-video-wrap">
		                          <p class="gather-file-icon"><i class="fa-solid fa-video"></i></p>
		                          <p class="gather-file-name">가나다라마바사아자차카타파하ABCDEFGHIJLMNOPRWEQWSFASFSDGSD1234567890</p>
		                          <p class="gather-file-date">유효기간<span>2022-05-03</span></p>
		              ...
		              <script>
		                $('.chat > .gather-file-wrap .file-menu').click(function () {
		                  $(this).next('.chat > .gather-file-wrap .file-content-wrap').stop().slideToggle(300);
		                  $(this).toggleClass('on').siblings().removeClass('on');
		                  $(this).next('.chat > .gather-file-wrap .file-content-wrap').siblings('.chat > .gather-file-wrap .file-content-wrap').slideUp(300); // 1개씩 펼치기
		                });
		                $('.chat > .gather-file-wrap .file-menu').first().trigger('click');
		              </script>
		              <!-- 파일 모아보기 끝 -->
		                ...
		                <div class="chat_field" id="chat">
		                  <div class="chat_name">
		                    <ul>
		                      ...
		                      <li>
		                        <a href="#!" class="closebtn"><i class="fas fa-sign-out-alt closebtn"></i></a>
		                      </li>
		                    </ul>
		                  </div>
		                  ...
		                  <div class="channel-popup-dim">
		                      ...
		                      <div class="chat-user-list-wrap">
		                        ...
		                        <div class="chat-user-list-contents">
		                          <ul class="chat-user-list">
		                            <li class="chat-user">
		                              <div class="invite-check"><input type="checkbox" id="invite" /><label for="invite"></label></div>
		                        ...
		                        <a href="#" class="chat-user-invite-btn"> <i class="fas fa-comments"></i>선택한 멤버들과 비밀 채팅 </a>
		                      </div>
		                      <!--번역언어 선택 팝업 시작-->
		                    ...
		                    <div class="newchat-invite-dim">
		                      <div class="newchat-invite-wrap">
		                        ...
		                        <div class="newchat-invite-contents"><span class="invite-send">-</span>님이<br />비밀 채팅방으로 초대하셨습니다.</div>
		                      ...
		                      <div class="popupLayer">
		                        <div class="popup">
		                          <ul class="popup_content">
		                            <li class="ico_whisper">
		                              <a href="#!"><i class="fa-regular fa-paper-plane"></i>귓속말 보내기</a>
		                              <div id="whisper">
		                                <form onsubmit="return false"><input type="text" name="message" /><button>보내기</button></form>
		                              </div>
		                            </li>
		                            <li>
		                              <a href="#!"><i class="fa-solid fa-comment"></i>1:1 채팅하기</a>
		                            </li>
		                            <li>
		                              <a href="#!"><i class="fas fa-not-equal"></i>신고하기</a>
		                            </li>
		                          </ul>
		                        </div>
		                      </div>
		              ...
		              <div id="draggable" class="newchat-popup-wrap">
		                <div class="newchat-popup-subwrap active">
		                  ...
		                  <div class="newchat-alret-dim active">
		                    ...
		                    <div class="newchat-alret-wrap newchat-user-list active">
		                      ...
		                      <div class="chat-user-list-contents">
		                        <ul class="chat-user-list">
		                          <li class="chat-user">
		                            <div class="invite-check"><input type="checkbox" id="invite1" /><label for="invite1"></label></div>
		                            <div class="user-profile-img profile-1"></div>
		                            <div class="user-name">가나다라마바사아자차카타파하</div>
		                            <div class="language">번역안함</div>
		                            <div class="lang-btn-wrap">
		                              <input type="checkbox" class="lang-btn" id="switch1" />
		                    ...
		                    <div class="newchat-alret-wrap out">
		                      <div class="newchat-alret-contents">
		                        ...
		                        <p class="newchat-alret-subtitle">채팅방을 나가시면<br />대화 내용은 모두 삭제됩니다.</p>
		                      </div>
		                      <div class="newchat-alret-btn-wrap">
		                        <a class="newchat-alret-btn">나가기</a>
		                        <a class="newchat-alret-btn">취소</a>
		                      </div>
		                    </div>
		                    ...
		                    <div class="newchat-alret-wrap closing">
		                      <div class="newchat-alret-contents">
		                        ...
		                        <p class="newchat-alret-subtitle">채팅방을 나가시면<br />대화 내용은 모두 삭제되고<br />모든 참여자의 채팅이 종료됩니다.</p>
		                      </div>
		                      <div class="newchat-alret-btn-wrap">
		                        <a class="newchat-alret-btn">확인</a>
		                        <a class="newchat-alret-btn">취소</a>
		                      </div>
		                    </div>
		                    ...
		                    <div class="newchat-alret-wrap end">
		                      <div class="newchat-alret-contents">
		                        ...
		                        <p class="newchat-alret-subtitle">해당 채팅방은 종료되었습니다.<br />모든 대화 내용은 삭제됩니다.</p>
		                      </div>
		                      <div class="newchat-alret-btn-wrap">
		                    ...
		                    <div class="newchat-alret-wrap invite">
		                      <div class="newchat-alret-contents">
		                        ...
		                        <p class="newchat-alret-subtitle">
		                          <span class="send-chat">가나다라마바사아차카타파하</span>님의 초대를 수락하실 경우<br />현재 참여중인 채팅은 종료됩니다.
		                        </p>
		                      </div>
		                      <div class="newchat-alret-btn-wrap">
		                        <a class="newchat-alret-btn">수락</a>
		                        <a class="newchat-alret-btn">거절</a>
		                      </div>
		                    </div>
		                  </div>
		                  <!--비밀 채팅 팝업 끝-->
		                  <div class="newchat-popup-title">
		                    <p>
		                      비밀 대화(<a class="chat-user-list_btn" href="#"><i class="fas fa-user"></i> 01</a>)
		                      <a class="gather-file_btn" href="#"><i class="fa-regular fa-folder-open"></i></a>
		                    </p>
		                    <p>
		                  ...
		                  <div class="newchat-popup-contents">
		                    ...
		                    <script>
		                      $('.newchat-popup-wrap .file-menu').click(function () {
		                        $(this).next('.newchat-popup-wrap .file-content-wrap').stop().slideToggle(300);
		                        $(this).toggleClass('on').siblings().removeClass('on');
		                        $(this).next('.newchat-popup-wrap .file-content-wrap').siblings('.newchat-popup-wrap .file-content-wrap').slideUp(300); // 1개씩 펼치기
		                      });
		                      $('.newchat-popup-wrap .file-menu').first().trigger('click');
		                    </script>
		                    <!-- 파일 모아보기 끝 -->
		                    <div class="newchat-chat-contents">
		                      ...
		                      <div class="newchat-comment-wrap">
		                        ...
		                        <a class="user-name" href="#!">가나다라마바사아자차카</a>
		                        <span class="comment"
		                          >가나다라마바사아자차카타파하가나다라마바사아자차카타파하가나다라마바사아자차카타파하가나다라마바사아자차카타파하</span
		                        >
		                      </div>
		                      <div class="newchat-comment-wrap">
		                        ...
		                        <a class="user-name" href="#!">가나다라마바사아자차카</a>
		                        <span class="comment"
		                          >가나다라마바사아자차카타파하가나다라마바사아자차카타파하가나다라마바사아자차카타파하가나다라마바사아자차카타파하가나다라마바사아자차카타파하가나다라마바사아자차카타파하</span
		                        >
		                      </div>
		                      <div class="newchat-comment-wrap">
		                      ...
		                      <div class="newchat-popupLayer">
		                        <div class="popup">
		                          <ul class="popup_content">
		                            <li class="ico_whisper">
		                              <a href="#!"><i class="fas fa-comment-alt"></i>귓속말 보내기</a>
		                ...
		                <div class="newchat-popup-input">
		                  ...
		                  <div class="newchat-write-wrap">
		                    ...
		                    <div class="newchat-textbox" id="subContent" maxlength="200" contenteditable="true" placeholder="메세지 입력하기"></div>
		                  </div>
		                  <!-- 이모지 및 이모티콘 영역 -->
		                  ...
		                  <script>
		                    $(document).ready(function () {
		                      $('.newchat-emoji-tab-wrap li.tab-link').click(function () {
		                        var tab_id = $(this).attr('data-tab');
		
		                        $('.newchat-emoji-tab-wrap li.tab-link').removeClass('current');
		                        $('.newchat-emoji-subwrap').removeClass('current');
