...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<ul
			...
			<!-- Nav Item - Dashboard -->
			<li class="nav-item"><a class="nav-link" href="/admin_page">
			...
			<li class="nav-item active"><a class="nav-link" href="#"
				...
				<div id="collapseTwo" class="collapse show"
					...
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item" href="/doNotPushMe">Buttons</a> <a
							class="collapse-item active" href="/card_trick">Cards</a>
					</div>
				</div></li>
			...
			<li class="nav-item"><a class="nav-link collapsed" href="#"
				...
				<div id="collapseUtilities" class="collapse"
					...
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item" href="/colors">Colors</a> <a
							class="collapse-item" href="/border">Borders</a> <a
							class="collapse-item" href="/animation">Animations</a>
			...
			<li class="nav-item"><a class="nav-link collapsed" href="#"
				...
				<div id="collapsePages" class="collapse"
					...
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item" href="/admin_login">Login</a> <a
							class="collapse-item" href="/register">Register</a> <a
							class="collapse-item" href="/pwLost">Forgot
							Password</a>
						<div class="collapse-divider"></div>
						<h6 class="collapse-header">Other Pages:</h6>
						<a class="collapse-item" href="/smaple_one">404 Page</a> <a
							class="collapse-item" href="/sample_two">Blank Page</a>
					</div>
				</div></li>
			...
			<!-- Nav Item - Tables -->
			<li class="nav-item"><a class="nav-link" href="/ad_table">
