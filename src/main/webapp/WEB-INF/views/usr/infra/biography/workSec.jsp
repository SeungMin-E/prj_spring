      ...
      <div class="container">
        <div class="row mb-4 align-items-center">
          <div class="col-md-6" data-aos="fade-up">
            <h2>접속해주셔서 감사합니다.</h2>
            <p>제가 속한 Team:Laika의 작품 Team Up! 입니다.</p>
          </div>
        </div>
      </div>
          ...
          <div class="row align-items-stretch">
            ...
            <div class="col-md-3 ml-auto" data-aos="fade-up" data-aos-delay="100">
              <div class="sticky-content">
                <h3 class="h3">Team Laika - Team up Project</h3>
                <p class="mb-4"><span class="text-muted">Team Project</span></p>

                <div class="mb-5">
                  <p>
                    &nbsp;운동하고 싶은 사람들끼리 모여서 같이 운동하는 사이트입니다.<br> 
                    파티를 만들어 모아서 같이 운동을 즐기는 사이트입니다.
                  </p>
                  <p>
                    &nbsp; 
            ...
            <div class="swiper-slide">
              <div class="testimonial-wrap">
                <div class="testimonial">
                  ...
                  <blockquote>
                    <p>반신반의 했지만은 해보고 나니까 믿고 쓸 수 있었어요</p>
                  </blockquote>
                  <p>&mdash; 최**</p>
                </div>
              </div>
